...
public class BoardController {
	...
	public ModelAndView boardWriteOk(HttpServletRequest request) {
		...
		vo.setTypesize(Integer.parseInt(request.getParameter("typesize"))); //
	...
	public ModelAndView boardIntro(pagingVO pVo) {
		System.out.println(pVo.getSearchKey()+", "+pVo.getSearchWord());
		...
		mav.addObject("lst", lst);
		mav.addObject("pVo", pVo);
		mav.setViewName("board/boardIntro");
