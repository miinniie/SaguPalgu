...
<script>
	...
	$(function(){
		...
		//이벤트발생
		$("#first input[type=radio]").eq(${vo.type-1}).trigger('change');
		$("#first>li>label").eq(${vo.type-1}).children("img").trigger('click');
		
		
		$("#size").val(${vo.typesize});
...
<div id="container">
	<div id="outside">
		<form method="post" id="editFrm" action="/myapp/board/boardEditOk">
			<input type="hidden" name="no" value="${vo.no}"/>
			<h1 style="margin-bottom:30px">글수정폼</h1>
			...
			<ul id="first" style="height: 90px">
				...
				<li>
					...
					<label for="icon3"><img onclick="changeSelect(this, 'size')" id="size3" value="size3" src="/myapp/resources/button3.png"  style="width:50px; height: 50px; border-radius: 100px; border: solid 2px #cfc0b8; padding: 5px; margin-left: 10px"></label>
					<label for="icon4"><img onclick="changeSelect(this, 'size')" id="size4" value="size4" src="/myapp/resources/button4.png"  style="width:50px; height: 50px; border-radius: 100px; border: solid 2px #cfc0b8; padding: 5px; margin-left: 10px"></label>
					<label for="icon5"><img onclick="changeSelect(this, 'size')" id="size5" value="size5" src="/myapp/resources/button5.png"  style="width:50px; height: 50px; border-radius: 100px; border: solid 2px #cfc0b8; padding: 5px; margin-left: 10px"></label>
				...
				<li>가격</li>
				<li><input type="text" name="price" id="price" size="80" placeholder="가격" value="${vo.price}" style="width:140px;"/></li>
				<li>거래위치</li>
				<li><input type="text" name="location" id="location" size="80" placeholder="거래 위치" value="${vo.location}" style="width:140px;"/></li>
			</ul>
			
			<ul id="second">
				<li>제목</li>
				<li><input type="text" name="title" id="title" size="80" maxlength="19" placeholder="제목" value="${vo.title}" style="width:380px;"/></li>
				<li>사이즈</li>
				<li>
					<!-- targetSelect -->
			...
			<ul id="last" style="margin-top: 25px; margin-left: 410px">
				<li>
					<input type="submit" id="boardBtn" value="수정하기" style="background-color:#cfc0b8; color: white; width: 130px ; cursor:pointer"/>
